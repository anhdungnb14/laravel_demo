...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $products = [
            ...
            ['id' => 10, 'name' => 'Áo nữ sơ mi chấm bi đỏ', 'code' => 'AN0032', 'slug' => 'ao-nu-so-mi-cham-bi-do', 'price' => 350000, 'featured' => 1, 'state' => 0, 'info' => 'Áo nữ sơ mi chấm bi đỏ', 'describer' => 'Áo nữ sơ mi chấm bi đỏ', 'image' => 'ao-nu-so-mi-cham-bi.jpg', 'categories_id' => 3],
            ...
            ['id' => 14, 'name' => 'Quần kaki vàng mận vàng', 'code' => 'KAKI3', 'slug' => 'quan-kaki-do-man-vang', 'price' => 350000, 'featured' => 1, 'state' => 0, 'info' => 'Quần kaki vàng mận', 'describer' => 'Quần kaki vàng mận', 'image' => 'quan-kaki-do-man-qk162-8273.jpg', 'categories_id' => 3],
