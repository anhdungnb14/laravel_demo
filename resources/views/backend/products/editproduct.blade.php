                            ...
                            <div class="row" style="margin-bottom:40px">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="image" type="file" name="image" class="form-control hidden"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="editor" name="describer"
                                                  style="width: 100%;height: 100px;">{{$product['describer']}}</textarea>
                                    </div>
                                    <button class="btn btn-success" name="add-product" type="submit">Sửa sản phẩm
                                    </button>
